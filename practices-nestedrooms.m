...
--
Q: random
A: Here we go! <br> ${ "Begin" button }
K: $back random
--
Q: specific
A: Here we go! <br> ${"Leggo" button } 
K: $back specific
--
...
@: specific consumption habit bigger_thing
...
Q: leggo
A: What topic do you want to look at? ${ "Consumption" button } ${ "Habits" button } ${ "Bigger things" button }
